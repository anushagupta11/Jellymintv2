document.addEventListener('DOMContentLoaded', () => {
  ...
  // Collapses sidebar on mobile width initially
  ...
  function appendMessageBubble(role, content, isTemporary = false) {
  ...
  function updateBotBubble(content) {
  ...
  async function sendMessage() {
    ...
    try {
      ...
      activeSession.messages.push({ role: 'assistant', content: botResponse });
      saveHistoryToServer();
